...
namespace Courses.Application.Abstracts
{
    public interface ICourseRepository
    {
        ...
        Task<ICollection<Course>> GetCoursesByStudentAsync(Guid studentId ,CourseQuery courseQuery, CancellationToken ct = default);
        Task<ICollection<Course>> GetCoursesByInstructorAsync(Guid instructorId,CourseQuery courseQuery, CancellationToken ct = default);
